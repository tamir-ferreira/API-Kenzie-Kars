...
export class InitialMigration1688047310280 implements MigrationInterface {
    name = 'InitialMigration1688047310280'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "images" ("id" SERIAL NOT NULL, "image_link_one" text, "image_link_two" text, "image_link_three" text, "image_link_four" text, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
