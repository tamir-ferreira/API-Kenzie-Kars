...
exports.CreateTables1688498078518 = void 0;
class CreateTables1688498078518 {
    constructor() {
        this.name = 'CreateTables1688498078518';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "zipCode" character varying(8) NOT NULL, "city" character varying NOT NULL, "state" character varying(2) NOT NULL, "street" character varying NOT NULL, "number" integer, "complement" character varying, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "title" character varying(200) NOT NULL, "content" character varying NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "userId" integer, "advertId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "images" ("id" SERIAL NOT NULL, "image_link_one" text, "image_link_two" text, "image_link_three" text, "image_link_four" text, "image_link_five" text, "image_link_six" text, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "adverts" ("id" SERIAL NOT NULL, "brand" character varying(40) NOT NULL, "model" character varying(40) NOT NULL, "year" integer NOT NULL, "fuel" character varying(10) NOT NULL, "mileage" integer NOT NULL, "color" character varying(20) NOT NULL, "fipe_price" numeric(12,2) NOT NULL DEFAULT '0', "price" numeric(12,2) NOT NULL DEFAULT '0', "description" text NOT NULL, "cover_image" text NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT 'true', "userId" integer, "imagesId" integer, CONSTRAINT "REL_1d01a85e6b6f93d54d1ed7af58" UNIQUE ("imagesId"), CONSTRAINT "PK_36876931b51109a932d0bf3b40a" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_bafb08f60d7857f4670c172a6ea" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "adverts" ADD CONSTRAINT "FK_1d01a85e6b6f93d54d1ed7af58e" FOREIGN KEY ("imagesId") REFERENCES "images"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "adverts" DROP CONSTRAINT "FK_1d01a85e6b6f93d54d1ed7af58e"`);
...
exports.CreateTables1688498078518 = CreateTables1688498078518;
