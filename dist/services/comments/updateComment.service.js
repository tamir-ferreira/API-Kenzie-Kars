...
const updateCommentService = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const commentRepository = data_source_1.AppDataSource.getRepository(comments_entity_1.Comment);
    const oldComment = yield commentRepository.findOne({
        where: { id: id },
    ...
    yield commentRepository
        .createQueryBuilder()
        .update(comments_entity_1.Comment)
        .set(data)
        .where("id = :id", { id: id })
        .execute();
