...
const updateAddressService = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    const addressRepository = data_source_1.AppDataSource.getRepository(addresses_entity_1.Address);
    const oldData = yield addressRepository.findOneBy({
        id: id,
    });
    const address = addressRepository.create(Object.assign(Object.assign({}, oldData), data));
    yield addressRepository.save(address);
    return addresses_schemas_1.returnAddressSchema.parse(address);
});
