...
const readUserByIdService = (idUser) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const categories = users_schemas_1.userSchemaResponse.parse(findUser);
    return categories;
});
exports.default = readUserByIdService;
